...
export default function Gereja1Page() {
    return (
        <div className="min-h-screen pb-12">
            <PageHeader
                title="Gereja Santo Yusuf Tambakrejo"
                subtitle="Gereja Induk Paroki Brayut"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="h-[300px] lg:h-full min-h-[300px] bg-gray-100 relative">
                            <iframe
                                ...
                                loading="lazy"
                                allowFullScreen
                                src="https://maps.google.com/maps?q=Gereja+Santo+Yusuf+Tambakrejo&t=&z=15&ie=UTF8&iwloc=&output=embed"
                            />
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 gap-y-8 md:gap-y-0">
                        ...
                        <div className="px-4 text-center">
                            ...
                            <div className="space-y-4 text-gray-700">
                                ...
                                <div>
                                    <div className="font-semibold">Misa OMK</div>
                                    <div className="text-sm text-gray-500">Minggu ke-3, 19.00 WIB</div>
                                </div>
                            </div>
                        </div>
                    </div>
