...
export const metadata: Metadata = {
    ...
    description: "Gereja St. Petrus Kayunan – Gereja Wilayah Paroki Brayut",
};

const KOORDINAT = "-7.689756720002525, 110.38640990847922";
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
                ...
                <section>
                    ...
                    <div className="prose prose-lg text-gray-700 max-w-none">
                        <p>
                            Selesai dibangun dan diberkati pada tahun 1974, lalu mulai tahun 2015 gedung utama Gereja direnovasi total.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        <div className="h-[300px] lg:h-full min-h-[300px] bg-gray-100 relative">
                            <iframe
                                width="100%"
                                height="100%"
                                title="Peta Lokasi Gereja St. Petrus Kayunan"
                        ...
                        <div className="p-8">
                            ...
                            <div className="space-y-6 text-gray-700">
                                <div>
                                    ...
                                    <p>Kayunan, Donoharjo, Ngaglik, Sleman, Yogyakarta</p>
                                </div>
                                <div className="pt-2">
                                    <a
                                        href={MAPS_LINK}
