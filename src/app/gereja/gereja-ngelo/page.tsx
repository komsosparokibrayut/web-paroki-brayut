...
export const metadata: Metadata = {
    title: "Gereja St. Venantius Ngelo | Paroki Brayut",
    description: "Gereja St. Venantius Ngelo – Gereja Wilayah Paroki Brayut",
};

const KOORDINAT = "-7.693161120623947, 110.36782765118424";
...
export default async function Gereja3Page() {
    const data = await getJadwalMisa();
    const churchData = data?.churches.find(c => c.id === "gereja-ngelo");
    ...
    return (
        <div className="min-h-screen pb-12">
            <PageHeader
                title="Gereja St. Venantius Ngelo"
                subtitle="Gereja Wilayah – Paroki Brayut"
                image="/images/carousel/GerejaNgelo.jpg"
                align="left"
            />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
                <section>
                    ...
                    <div className="prose prose-lg text-gray-700 max-w-none">
                        <p>Mulai dibangun pada tahun 1984, dan diresmikan tahun 1988.</p>
                    </div>
                </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        <div className="h-[300px] lg:h-full min-h-[300px] bg-gray-100 relative">
                            <iframe
                                ...
                                title="Peta Lokasi Gereja St. Venantius Ngelo"
                        ...
                        <div className="p-8">
                            ...
                            <div className="space-y-6 text-gray-700">
                                <div>
                                    ...
                                    <p>Ngelo, Pandowoharjo, Sleman, Yogyakarta</p>
                                </div>
                                <div className="pt-2">
                ...
                <section>
                    ...
                    <GerejaGallery photos={[]} churchName="Gereja St. Venantius Ngelo" />
                </section>
            </div>
        </div>
    );
