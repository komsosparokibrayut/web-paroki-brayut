        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 border-b border-white/10 pb-20 mb-20'>
          ...
          >
            <h2 className='font-serif text-4xl md:text-5xl leading-tight mb-6'>
              Bergabung dengan <br />{" "}
              <span className='text-brand-gold italic'>Keluarga Kami</span>
            </h2>
            <p className='text-gray-400 text-lg max-w-md mb-8'>
              Kami menantikan kehadiran Anda dalam perayaan Ekaristi dan
              kegiatan komunitas.
            </p>
            <Link
              href='/jadwal-misa'
              className='group inline-flex items-center text-lg font-bold uppercase tracking-widest hover:text-brand-gold transition-colors'
            >
              Lihat Jadwal Misa
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20'>
          ...
          <div className='space-y-6'>
            ...
            <div className='flex gap-4'>
              <Link
                href='https://www.instagram.com/parokibrayut/'
                target='_blank'
                rel='noopener noreferrer'
                className='h-10 w-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-blue hover:text-white transition-all'
              >
                <SiInstagram className='h-5 w-5' />
              </Link>
              <Link
                href='https://www.youtube.com/@parokibrayut4974'
                target='_blank'
                rel='noopener noreferrer'
                className='h-10 w-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-blue hover:text-white transition-all'
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className='font-bold text-lg mb-4 uppercase tracking-wider text-white'>
              Jelajahi
            </h4>
            <ul className='space-y-2'>
              {[
                ...
                <li key={item.label}>
                  <Link
                    href={item.href}
                    className='text-gray-300 hover:text-brand-gold transition-colors block py-1 border-b border-transparent hover:border-brand-gold/30 w-fit'
                  >
                    {item.label}
                  </Link>
                </li>
          ...
          <div className='lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8'>
            <div>
              <h4 className='flex gap-2 items-center font-bold text-lg mb-4 uppercase tracking-wider text-white'>
                <Church className='h-5 w-5 text-brand-gold mb-2' />
                Gereja Utama
              </h4>
            ...
            <div>
              <h4 className='flex gap-2 items-center font-bold text-lg mb-4 uppercase tracking-wider text-white'>
                <House className='h-5 w-5 text-brand-gold mb-2' />
                Sekretariat
              </h4>
              <address className='not-italic text-gray-300 space-y-2 leading-relaxed'>
                <Link
                  href='https://maps.google.com/?q=Gereja+Katholik+St.+Yohanes+Paulus+II+Brayut,+Jogopaten,+Pandowoharjo'
                  target='_blank'
                  rel='noopener noreferrer'
                  className='hover:text-brand-gold transition-colors block'
                >
        ...
        <div className='border-t border-white/10 pt-12'>
          <div className='flex flex-col md:flex-row justify-between items-center gap-6'>
            <p className='text-gray-500 text-sm'>
              &copy; {new Date().getFullYear()} KOMSOS Paroki Santo Yohanes
              Paulus II Brayut. All rights reserved.
            </p>
          </div>
