        ...
        <div className='container mx-auto px-4 relative z-10 h-full flex items-center'>
          ...
          <div className='max-w-4xl space-y-12'>
            <div className='space-y-4'>
              ...
              >
                Membangun Rumah{" "}
                <span className='italic text-brand-gold'>Tuhan</span>, <br />
            ...
            <div className='space-y-6 text-lg md:text-xl leading-relaxed text-gray-200 max-w-2xl'>
              ...
              >
                Kami umat di Paroki Santo Yohanes Paulus II Brayut, merencanakan
                untuk mengembangkan Gereja pusat yang lebih memadai dengan
                berbagai sarana yaitu, pastoran, taman doa, gedung pertemuan,
                dan ruang pelayanan.
              </motion.p>
            </div>
          </div>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-center'>
                      ...
                      <div className='flex-1 w-full space-y-4'>
                        {[
                          ...
                          >
                            ...
                            <span className='font-mono text-gray-500 group-hover:text-brand-dark transition-colors'>
                              {bank.number}
                            </span>
                          </div>
                        ))}
              ...
              >
                <blockquote className='font-serif italic text-xl text-gray-600 leading-relaxed'>
                  ...
                  sukacita.&quot;
                  <footer className='text-sm font-sans not-italic text-gray-400 mt-2'>
                    — 2 Korintus 9:7
                  </footer>
                </blockquote>
                <div className='pt-8 border-t border-gray-100'>
